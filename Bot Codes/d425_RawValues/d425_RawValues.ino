  ...
  for (int i = 0; i < 3; i++) {
    ...
    switch (i) {
      case 0:
        ...
        if (dataCapture && indexOfArray < 300) {
...
String GetStationCodeFromDataReadByStationSensor() {
  ...
  if (_readingInProcess) {
    ...
    if (_previousIntermediateColumnCode != "000" && _previousIntermediateColumnCode != "111" && _intermediateColumnCode == "111" && _intermediateColumnCode != "000" && _finalColumnCodeArray[0] != _previousIntermediateColumnCode) {
      ...
      add_log("FC: " + String(_intermediateColumnFramesCount));
      add_log("Intensity: { " + String(_intermediateIntensitySumArray[0]/_intermediateColumnFramesCount) + ", " + String(_intermediateIntensitySumArray[1]/_intermediateColumnFramesCount) + ", " + String(_intermediateIntensitySumArray[2]/_intermediateColumnFramesCount) + " }");
    }
